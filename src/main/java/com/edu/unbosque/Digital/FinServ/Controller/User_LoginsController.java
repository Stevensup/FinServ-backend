...
public class User_LoginsController {
    ...
    @PostMapping("/create")
    @Operation(
        summary = "Create a new user logins", 
        description = "Create a new user logins"
    )
    @ApiResponse(
        responseCode = "200", 
        description = "User logins created"
    )
    ...
    @ApiResponse(
        responseCode = "200", 
        description = "User logins retrieved"
    )
    ...
    @Operation(
        summary = "Update a logins", 
        description = "Update a logins"
    )
    @ApiResponse(
        responseCode = "200", 
    ...
    @Operation(
        summary = "Delete a logins", 
        description = "Delete a logins"
    )
    @ApiResponse(
        responseCode = "200", 
